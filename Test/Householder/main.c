...
PI_L1 double Q[N_CHANNELS][N_CHANNELS]; 
PI_L1 double R[N_CHANNELS][EV_WINDOWS_SIZE];
PI_L1 double v[N_CHANNELS];
PI_L1 double sel_col[N_CHANNELS];
PI_L1 double Q_temp[N_CHANNELS][N_CHANNELS];
PI_L1 double R_temp[N_CHANNELS][EV_WINDOWS_SIZE];
PI_L1 double H[N_CHANNELS][N_CHANNELS];
PI_L1 double input_temp[N_CHANNELS][EV_WINDOWS_SIZE];
PI_L1 double n;
PI_L1 int i2;
PI_L1 double zero = 0;
PI_L1 double one = 1;
PI_L1 double two = 2;
PI_L1 double temp;
PI_L1 static double buffer[NUM_CORES];
PI_L1 static int idx[NUM_CORES];
